<template>
  <div id="home" class="container pt-24 md:pt-48 px-6 mx-auto">
    <!-- breadcrumb -->
    ...
    <div v-show="isSupplier" class="flex flex-wrap -mx-3 mb-20">
    ...
    <div class="flex flex-wrap -mx-3">
      <div class="w-full xl:w-1/3 px-3">
        <p class="text-xl font-semibold mb-4">Current Products</p>

        <div
          v-if="!isSupplier"
          class="w-full bg-white border rounded-lg p-4 mb-8 xl:mb-0"
        >
          <div v-for="p in products" :key="p.index">
            <ProductCard
              :name="p.title"
              :desc="p.sku"
              :price="p.unit_price"
              :curr="p.currency"
              :suppId="p.supplier_id"
              :id="p.id"
            />
          </div>
        </div>
        <div
          ...
          class="w-full bg-white border rounded-lg p-4 mb-8 xl:mb-0"
        >
          <div v-for="p in supProducts" :key="p.index">
            <ProductCard
              :name="p.title"
              :desc="p.sku"
              :price="p.unit_price"
...
export default {
  ...
  computed: {
    ...
    getSuppliers() {
      return [...new Set(this.products.map((item) => item.supplier_id))];
    },
    cart() {
